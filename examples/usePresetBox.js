import { Preset } from '@pixi/color-filters';
...
export function usePresetBox(app, gui)
{
    let html = ``;
    ...
    Array.from(document.querySelectorAll('#presetBox button')).forEach(
        (button) =>
        {
            button.addEventListener('click', () =>
            {
                gui.reset(true);
                const filter = new Preset(button.dataset.key);
